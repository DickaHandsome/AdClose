...
/**
 * 全局 HOOK 管理 + 日志 — 从设置入口或逆向工坊的 HOOK管理模块跳转而来
 */
class CustomHookManagerActivity : AppCompatActivity(), OnBackPressContainer, INavContainer {
    ...
    private fun setupViewPager() {
        viewPager.apply {
            adapter = ViewPagerAdapter(this@CustomHookManagerActivity, targetPackageName)
